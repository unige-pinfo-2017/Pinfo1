...
public class WSO2ServiceImpl implements WSO2Service {
	...
	public State[] getPowerSensorState(String deviceId, String from, String to, TypePowerSocketSensors sensorType) {
		...
		String mock = "[{\"values\":{\"meta_owner\":\"admin\",\"meta_deviceType\":\"powersocketubiquiti\",\"meta_time\":1493290847263,\"powerSensor\":0.0,\"_version\":\"1.0.0\",\"meta_deviceId\":\"qxoblpnqwzfp\"},\"id\":\"604604ce-7e3f-312a-8ed6-7fb8f2b32113\"},{\"values\":{\"meta_owner\":\"admin\",\"meta_deviceType\":\"powersocketubiquiti\",\"meta_time\":1493290855191,\"powerSensor\":1.98,\"_version\":\"1.0.0\",\"meta_deviceId\":\"qxoblpnqwzfp\"},\"id\":\"75bc0fb3-a1e0-35f2-970f-992650ad85c7\"}]";
	...
	public State[] getBeaconState(String deviceId, String from, String to, TypeBeaconSensors sensorType) {
		...
		String mock = "[{\"values\":{\"meta_owner\":\"admin\",\"meta_deviceType\":\"estimotebeacon\",\"meta_time\":1493290847263,\"temperatureSensor\":20.0,\"_version\":\"1.0.0\",\"meta_deviceId\":\"qxoblpnqwzfp\"},\"id\":\"604604ce-7e3f-312a-8ed6-7fb8f2b32113\"},{\"values\":{\"meta_owner\":\"admin\",\"meta_deviceType\":\"estimotebeacon\",\"meta_time\":1493290855191,\"temperatureSensor\":23.50,\"_version\":\"1.0.0\",\"meta_deviceId\":\"qxoblpnqwzfp\"},\"id\":\"75bc0fb3-a1e0-35f2-970f-992650ad85c7\"}]";

		Gson gson = new Gson();
		State[] states = null;
		switch(sensorType){
		case temperatureSensor: states = gson.fromJson(mock, State[].class); break;
		case lightSensor: states = gson.fromJson(mock, State[].class); break;
		case batterySensor: states = gson.fromJson(mock, State[].class); break;
		}
		return states;
	}
